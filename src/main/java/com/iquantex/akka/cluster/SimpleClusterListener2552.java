 ...
 * @author quail
 */
public class SimpleClusterListener2552 extends UntypedActor {
    ...
    public static void main(String[] args) {
        ...
        ActorRef listenerActor = system.actorOf(Props.create(SimpleClusterListener2552.class), "simpleClusterListener");
