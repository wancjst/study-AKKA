 ...
 * @author quail
 */
public class MyAkkaClusterServer2552 extends UntypedActor {
    ...
    public static void main(String[] args) {
        ...
        ActorSystem system = ActorSystem.create("akkaClusterTest", ConfigFactory.load("reference-2552.conf"));
        system.actorOf(Props.create(MyAkkaClusterServer2552.class), "myAkkaClusterServer");
