 ...
 * @author quail
 */
public class MyAkkaClusterClient2554 extends UntypedActor {
    ...
    public void onReceive(Object msg) throws Exception {
        if(msg instanceof TransformationMessage.TransformationJob && backends.isEmpty()){// 无服务提供者
            ...
            getSender().tell(new TransformationMessage.JobFailed("Service unavailable, try again later", job),getSender());
        ...
        }else if((msg instanceof Integer?(int) msg  == TransformationMessage.BACKEND_REGISTRATION ? true : false : false)){
            /*
            注册服务提供者
             */
    ...
    public static void main(String[] args) {
        ...
        ActorSystem system = ActorSystem.create("akkaClusterTest", ConfigFactory.load("reference-2554.conf"));
        final ActorRef myAkkaClusterClient2554 = system.actorOf(Props.create(MyAkkaClusterClient2554.class), "myAkkaClusterClient2554");
        ...
        system.scheduler().schedule(interval, interval, ()->{
                Patterns.ask(myAkkaClusterClient2554, new TransformationMessage.TransformationJob("hello-" + counter.incrementAndGet()), timeout)
